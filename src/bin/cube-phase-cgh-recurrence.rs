...
use holography::cgh::recurrence::CghProcessorRecurrence;
...
fn main() -> io::Result<()> {
    ...
    let processor = CghProcessorRecurrence;

    generate_cgh(&processor, &tri_func, &config, &object)
        .save("out/cube-phase-cgh-recurrence.bmp")?;
